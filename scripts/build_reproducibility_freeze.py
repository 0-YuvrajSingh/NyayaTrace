...
FREEZE_VERSION = "final-reproducibility-freeze-v4-e3e4-prediction"
...
def main() -> None:
    ...
    e3_e4_prediction_config = json.loads(
        (ROOT / "config/e3_e4_evidence_augmented_prediction.json").read_text(encoding="utf-8")
    )
    e3_e4_evaluation = json.loads(
    ...
    result = {
        ...
        "scope": "Final retrieval freeze plus the later E3/E4 evidence-augmented prediction revision; E1/E2, corpus, splits, answer key, and retrieval configuration remain unchanged.",
        "revision_history": [
            {
                "date": "2026-09-06",
                "config_id": e3_e4_prediction_config["config_id"],
                "changes": [
                    "Added E3/E4 outcome prediction by reusing frozen E2 checkpoint-6318 through inference-time evidence augmentation.",
                    "Removed FEER and FCER from reported metrics on the project mentor's guidance.",
                ],
                "checkpoint_reused_from_E2_sha256": e3_e4_prediction_config["model"]["checkpoint_sha256"],
                "unchanged": ["E1", "E2", "ILDC corpus and splits", "eCourts corpus", "answer key", "retrieval configuration"],
            }
        ],
        "datasets_and_splits": {
            "ildc_single": {
        ...
        "experiments": {
            ...
            "E3_E4_evidence_augmented_prediction": {
                "config": file_record("config/e3_e4_evidence_augmented_prediction.json"),
                "implementation": {
                    relative_path: file_record(relative_path)
                    for relative_path in (
                        "src/legal_xai/evidence_augmented_prediction.py",
                        "scripts/run_evidence_pipeline.py",
                        "scripts/run_grounded_answer_pipeline.py",
                        "scripts/run_e3_e4_evidence_augmented_evaluation.py",
                        "scripts/replay_e3_e4_evidence_augmented_evaluation.py",
                    )
                },
                "result": file_record("artifacts/e3_e4_evidence_augmented_evaluation.json"),
                "error_analysis": file_record("artifacts/e3_e4_prediction_error_analysis.json"),
                "config_id": e3_e4_prediction_config["config_id"],
                "method": e3_e4_prediction_config["method"],
                "checkpoint_reuse": {
                    "source_experiment": "E2_corrected",
                    "checkpoint_path": e3_e4_prediction_config["model"]["checkpoint"],
                    "weights": file_record(
                        "artifacts/e2_chunk_pool_checkpoints_cached/checkpoint-6318/model.safetensors"
                    ),
                    "new_training_or_fine_tuning": False,
                },
                "shared_E3_E4_inference": e3_e4_prediction_config["inference"],
                "shared_E3_E4_input": e3_e4_prediction_config["input"],
                "population": e3_e4_evaluation["population"],
                "metrics": {
                    "E3": e3_e4_evaluation["E3_outcome_prediction"],
                    "E4": e3_e4_evaluation["E4_outcome_prediction"],
                },
                "replay_verification": {
                    "date": "2026-09-06",
                    "status": "PASS",
                    "stable_sha256": "852b42d1f971b71a7b614d4aa7802a2107339760290581a5e72c1f1688a993ca0",
                    "excluded_nondeterministic_fields": ["retrieval_run_id"],
                },
                "canonical_prediction_delta": False,
            },
            "E4": {
                "implementation": {
                    relative_path: file_record(relative_path)
        ...
        "replay_contract": {
            ...
            "E3_E4_prediction_replay": {
                "script": "scripts/replay_e3_e4_evidence_augmented_evaluation.py",
                "population_n": 30,
                "comparison": "A fresh E3/E4-only retrieval, verification, and prediction run must match the versioned reference artifact after excluding generated retrieval-run IDs.",
            },
        },
    }
    ...
    markdown = "\n".join([
        ...
        "",
        "This records the fixed data, model, retrieval, explanation, safety, and later E3/E4 evidence-augmented prediction configuration. E1/E2 and the frozen datasets remain unchanged.",
        "",
        ...
        f"- E3/E4 prediction revision: `{e3_e4_prediction_config['config_id']}` reuses checkpoint-6318 without training; both systems score accuracy `{e3_e4_evaluation['E3_outcome_prediction']['accuracy']}` and macro F1 `{e3_e4_evaluation['E3_outcome_prediction']['macro_f1']}` on the frozen 30-case subset.",
        "- Reporting revision: FEER and FCER were removed from the reported metrics on the project mentor's guidance. Direct temporal-eligibility and violation counts remain recorded.",
        ...
        "- The bounded evidence replay is executed by `scripts/run_week10_reproducibility_replay.py`; the 30-case E3/E4 prediction replay is executed by `scripts/replay_e3_e4_evidence_augmented_evaluation.py`.",
        "",
    ])

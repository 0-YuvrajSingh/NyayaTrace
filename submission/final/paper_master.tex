...
Public judgments do not remove privacy or misuse concerns: no end-user search
...
(\texttt{924a5bb9\ldots dbdc773}) with a stable replay hash. The implementation passes 81 automated tests and the documented
reproducibility checks (14/14 documentation and 34/34 freeze-hash
checks), replaying deterministically from a clean clone. Code and artifacts are available

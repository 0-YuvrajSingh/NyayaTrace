...
yuvraj2312026@akgec.ac.in & rishi2312003@akgec.ac.in \\[2ex]
Rahul Ranjan & Saurav Kumar Chaudhary \\
\textit{Department of Computer Science and Engineering} & \textit{Department of Computer Science and Engineering} \\
\textit{Ajay Kumar Garg Engineering College} & \textit{Ajay Kumar Garg Engineering College} \\
Ghaziabad, India & Ghaziabad, India \\
rahul2312151@akgec.ac.in & saurav2312023@akgec.ac.in
\end{tabular}
}
...
$+$1.95, 4.66 vs.\ 2.71); see Fig.~\ref{fig:explanation}.
...
reproducibility checks (14/14 documentation and a freeze audit of 39 recorded
entries: 28 byte-exact, 1 matching after line-ending normalisation,
10 differing only in non-scientific metadata such as build timestamps,
retrieval run UUIDs, and platform version strings, with all reported
metrics verified identical). Separately, the
reproducibility checks (14/14 documentation checks and a freeze audit of 39 recorded
entries: 28 byte-exact, 1 after line-ending normalisation, and 10 differing only in

...
output hash. The implementation passes 81 automated tests and 43
reproducibility-freeze integrity checks, and the evidence-augmented evaluation
replays deterministically from a clean clone. Code and artifacts are available
at \url{https://github.com/rishiraj103/Explainable-AI-for-Indian-Legal-Research-An-Evidence-Grounded-Framework}.

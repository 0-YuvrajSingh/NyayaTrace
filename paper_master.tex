...
TaxFlow applies hybrid RAG with statutory validity filtering to Indian statutory tax
...
research-pipeline tests (75 host-runnable plus 6
  ...
  entries, 29 byte-exact, the remainder differing only in documented
  non-scientific metadata), replaying deterministically from a clean clone. Separately, the

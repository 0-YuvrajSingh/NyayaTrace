...
The final candidate log contains 3,000/3,000 eligible candidates, and all 150 displayed citations are eligible. The preserved post-ranking baseline contained 1,712 later-year candidates among 2,743 logged candidates, plus 267 same-year candidates excluded as ambiguous. These counts show that ineligible candidates were a real capacity constraint. Two temporal exposure-rate metrics were later removed from reporting on the project mentor's guidance.

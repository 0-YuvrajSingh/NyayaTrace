...
> Historical working draft. The current paper source, including the later E3/E4 evidence-augmented prediction revision, is `submission/paper.md`.
...
| Evidence-augmented prediction input | Frozen facts extract followed by selected verbatim passages in selection order |

...
- Freeze version: `final-reproducibility-freeze-v4-e3e4-prediction`
...
- E3/E4 prediction revision: `e3e4-evidence-augmented-inlegalbert-checkpoint6318-v1` reuses checkpoint-6318 without training; both systems score accuracy `0.666667` and macro F1 `0.603175` on the frozen 30-case subset.
